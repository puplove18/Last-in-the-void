...
public class StarSystem{
    ...
    public StarSystem(){
        ...
        this.planets[1] = new Planet("Deep Space Mineral Planet", Type.Mineral, 20, "Midplanet", 1);
        this.planets[2] = new Planet("Deep Space Organic Planet", Type.Organic, 70, "Midplanet", 1);
